...
(function ($) {
    $.fn.crossword = function (entryData) {
        ...
        */
        ...
        this.after('<div id="puzzle-clues"><h2>Horizontales</h2><ul id="across"></ul><h2>Verticales</h2><ul id="down"></ul></div>');
            ...
            calcCoords: function () {
                ...
                */
                for (var i = 0, p = entryCount; i < p; ++i) {
                    ...
                    $('#' + puzz.data[i].orientation).append('<li tabindex="1" data-position="' + i + '">' + (puzz.data[i].position + 1) + ". " + puzz.data[i].clue + '</li>');
                }
